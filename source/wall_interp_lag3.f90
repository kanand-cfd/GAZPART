...
! interpolated on the point "XINT,YINT,ZINT" and the result is "UINT".   
!                                                                       
!=====================================================================
subroutine WALL_INTERP_LAG3(XAIN,YAIN,ZAIN, &
                            UAIN,           &
                            XINT,YINT,ZINT, &
                            UINT            )
!=====================================================================
...
real(kind=8), intent(out) :: UINT
   
!- Positions for interpolation 
real(kind=8), intent(in) :: XINT
real(kind=8), intent(in) :: YINT
real(kind=8), intent(in) :: ZINT
...
!write(*,*) DXAINT, DYAINT, DZAINT

!!====================================================================
!! 1. Interpolation nodes location
!!====================================================================
 I0 = int(XINT/ DXAINT) + 1
 J0 = int(YINT/ DYAINT) + 1
 K0 = int(ZINT/ DZAINT) + 1
!write(*,*) I0, J0, K0
...
!!====================================================================
 ALFA = (XINT-XAIN(I0)) / DXAINT
 BETA = (YINT-YAIN(J0)) / DYAINT
 GAMA = (ZINT-ZAIN(K0)) / DZAINT
...
end subroutine WALL_INTERP_LAG3
